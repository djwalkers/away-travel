...
export default function CommitteeHubPage() {
  ...
  // --- SOCIAL / WHATSAPP COPY GENERATOR ---
  ...
  return (
    <main className="min-h-screen bg-slate-50 dark:bg-[#070b14] text-slate-900 dark:text-slate-100 p-6 md:p-12 transition-colors">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 dark:border-[#1a2742] pb-6">
          <div>
            <div className="flex items-center gap-2">
              <Link href="/admin/fixtures" className="text-xs font-bold text-slate-500 dark:text-slate-400 hover:text-white transition">
                ← Matchday Operations
              </Link>
            </div>
            <h1 className="text-3xl font-black text-slate-900 dark:text-white mt-1 flex items-center gap-2.5">
              <ShieldCheck className="h-8 w-8 text-blue-600 dark:text-[#ffc72c]" />
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/admin/fixtures"
              className="rounded-xl border border-slate-200 dark:border-[#1a2742] bg-white dark:bg-[#0e1726] px-4 py-2 text-xs font-bold text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition shadow-sm"
            >
              Steward Manifests
            </Link>
          </div>
        ...
        {/* 4 Navigation Tabs */}
        <div className="flex flex-wrap items-center gap-2 border-b border-slate-200 dark:border-[#1a2742] pb-1">
          <button
            onClick={() => setActiveTab('analytics')}
            className={`inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-bold transition ${
              activeTab === 'analytics'
                ? 'bg-blue-600 dark:bg-[#ffc72c] text-white dark:text-[#070b14] shadow'
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="rounded-2xl border border-slate-200 dark:border-[#1a2742] bg-white dark:bg-[#0a1220] p-5 shadow-lg space-y-1">
                ...
                <div className="text-3xl font-black text-slate-900 dark:text-white flex items-center gap-2">
                  <Users className="h-6 w-6 text-blue-600 dark:text-[#ffc72c]" />
              ...
              <div className="rounded-2xl border border-slate-200 dark:border-[#1a2742] bg-white dark:bg-[#0a1220] p-5 shadow-lg space-y-1">
                <span className="text-[10px] uppercase font-bold text-slate-500 dark:text-slate-400">Fleet Occupancy Rate</span>
              ...
              <div className="rounded-2xl border border-slate-200 dark:border-[#1a2742] bg-white dark:bg-[#0a1220] p-5 shadow-lg space-y-1">
                <span className="text-[10px] uppercase font-bold text-slate-500 dark:text-slate-400">Total Travel Revenue</span>
                <div className="text-3xl font-black text-blue-600 dark:text-[#ffc72c] flex items-center gap-2">
              ...
              <div className="rounded-2xl border border-slate-200 dark:border-[#1a2742] bg-white dark:bg-[#0a1220] p-5 shadow-lg space-y-1">
                <span className="text-[10px] uppercase font-bold text-slate-500 dark:text-slate-400">Salop Coach Mileage</span>
                <div className="text-3xl font-black text-slate-900 dark:text-white flex items-center gap-2">
            ...
            <div className="rounded-2xl border border-slate-200 dark:border-[#1a2742] bg-white dark:bg-[#0a1220] p-6 shadow-xl space-y-4">
              <div className="flex items-center justify-between border-b border-slate-100 dark:border-[#1a2742] pb-3">
                <h3 className="font-bold text-slate-900 dark:text-white text-sm flex items-center gap-2">
                  <MapPin className="h-4 w-4 text-blue-600 dark:text-[#ffc72c]" />
                    ...
                    return (
                      <div key={idx} className="space-y-1">
                        <div className="flex justify-between text-xs font-bold">
                          <span className="text-slate-800 dark:text-white">{idx + 1}. {stopName}</span>
                          <span className="text-blue-600 dark:text-[#ffc72c]">{count} fans ({percentage}%)</span>
                        </div>
                        <div className="w-full h-2 rounded-full bg-slate-100 dark:bg-[#070b14] overflow-hidden">
                          <div
                            className="h-full bg-blue-600 dark:bg-[#ffc72c] rounded-full transition-all duration-500"
        ...
        {activeTab === 'waitlist' && (
          <div className="space-y-4">
            <div className="rounded-2xl border border-slate-200 dark:border-[#1a2742] bg-white dark:bg-[#0a1220] p-6 shadow-xl space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-100 dark:border-[#1a2742] pb-4">
                <div>
                ...
                <span className="text-xs font-bold px-3 py-1 rounded-full bg-amber-500/10 text-amber-700 dark:text-[#ffc72c] border border-amber-500/30">
                  {waitlist.length} In Queue
                </span>
              </div>

              {promotionResult && (
                <div className="p-4 rounded-xl border border-emerald-500/30 bg-emerald-500/10 text-emerald-800 dark:text-emerald-300 text-xs space-y-2">
                  ...
                  <div className="pt-1 flex items-center gap-2">
                    <a
                      href={`https://wa.me/44${promotionResult.phone.replace(/[^0-9]/g, '').slice(1)}?text=${encodeURIComponent(
              ...
              {waitlist.length === 0 ? (
                <div className="p-12 text-center text-slate-500 text-sm space-y-2">
                  ...
                  <p className="font-bold text-slate-900 dark:text-white">Waiting List is Clean!</p>
                  <p className="text-xs text-slate-500">Every supporter has a confirmed seat on our active coaches.</p>
                </div>
              ) : (
                <div className="divide-y divide-slate-100 dark:divide-[#1a2742]">
                    ...
                    <div key={item.id} className="py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="px-2 py-0.5 rounded-full bg-blue-500/10 text-blue-600 dark:text-[#ffc72c] text-[10px] font-bold">
                        ...
                        <div className="flex flex-wrap items-center gap-3 text-xs text-slate-500 dark:text-slate-400">
                          ...
                          <span>
                            Joined: {new Date(item.created_at).toLocaleDateString('en-GB', { day: 'numeric', month: 'short' })}
                          </span>
                        </div>
                      </div>
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-xl bg-blue-600 dark:bg-[#ffc72c] px-4 py-2 text-xs font-black text-white dark:text-[#070b14] hover:opacity-90 transition shadow-md shrink-0"
                      >
        ...
        {activeTab === 'broadcast' && (
          <div className="grid md:grid-cols-3 gap-6">
            <div className="md:col-span-1 space-y-4">
              <div className="rounded-2xl border border-slate-200 dark:border-[#1a2742] bg-white dark:bg-[#0a1220] p-5 shadow-lg space-y-3">
                    ...
                    <button
                      ...
                      className={`w-full text-left p-3 rounded-xl border text-xs font-bold transition ${
                        selectedFixtureForBroadcast?.id === f.id
                          ? 'border-blue-500 dark:border-[#ffc72c] bg-blue-500/10 text-blue-600 dark:text-[#ffc72c]'
                          : 'border-slate-200 dark:border-[#1a2742] text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-[#0e1726]'
                      }`}
                    >
            ...
            <div className="md:col-span-2 space-y-4">
              <div className="rounded-2xl border border-slate-200 dark:border-[#1a2742] bg-white dark:bg-[#0a1220] p-6 shadow-xl space-y-4">
                ...
                <div className="rounded-xl border border-slate-200 dark:border-[#1a2742] bg-slate-50 dark:bg-[#070b14] p-4 font-mono text-xs text-slate-800 dark:text-slate-200 whitespace-pre-wrap leading-relaxed">
                  {broadcastText}
                </div>
              </div>
            </div>
        ...
        {activeTab === 'pl' && (
          <div className="space-y-6">
            <div className="grid grid-cols-3 gap-4">
              <div className="rounded-2xl border border-slate-200 dark:border-[#1a2742] bg-white dark:bg-[#0a1220] p-5 shadow-lg">
                <span className="text-[10px] uppercase font-bold text-slate-500">Gross Ticket Revenue</span>
              ...
              <div className="rounded-2xl border border-slate-200 dark:border-[#1a2742] bg-white dark:bg-[#0a1220] p-5 shadow-lg">
                <span className="text-[10px] uppercase font-bold text-slate-500">Total Coach Hire Invoices</span>
              ...
              <div className="rounded-2xl border border-slate-200 dark:border-[#1a2742] bg-white dark:bg-[#0a1220] p-5 shadow-lg">
                <span className="text-[10px] uppercase font-bold text-slate-500">Net Supporter Club Surplus</span>
                <div className={`text-2xl font-black mt-1 ${totalRevenue >= totalHireCosts ? 'text-blue-600 dark:text-[#ffc72c]' : 'text-rose-500'}`}>
                  £{(totalRevenue - totalHireCosts).toFixed(2)}
                </div>
              </div>
            </div>

            <div className="rounded-2xl border border-slate-200 dark:border-[#1a2742] bg-white dark:bg-[#0a1220] overflow-hidden shadow-xl">
              <div className="p-5 border-b border-slate-100 dark:border-[#1a2742]">
                <h3 className="font-bold text-slate-900 dark:text-white text-sm">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs">
                  <thead>
                    <tr className="border-b border-slate-200 dark:border-[#1a2742] bg-slate-100 dark:bg-[#0e1726] text-slate-600 dark:text-slate-400">
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-[#1a2742]">
                    {fixtures.filter((f) => f.is_released).map((f) => {
                      ...
                      return (
                        <tr key={f.id} className="hover:bg-slate-50 dark:hover:bg-[#0e1726]/40 transition">
                          <td className="p-3.5 font-bold text-slate-900 dark:text-white">vs {f.opponent}</td>
                          <td className="p-3.5 text-slate-600 dark:text-slate-300">{coaches.length} Coach(es)</td>
                          <td className="p-3.5 text-slate-600 dark:text-slate-300">{booked} passengers</td>
                          <td className="p-3.5 font-bold text-emerald-600 dark:text-emerald-400">£{revenue.toFixed(2)}</td>
                          <td className="p-3.5 text-slate-600 dark:text-slate-400">£{hireCost.toFixed(2)}</td>
                          <td className={`p-3.5 font-black text-right ${net >= 0 ? 'text-blue-600 dark:text-[#ffc72c]' : 'text-rose-500'}`}>
                            £{net.toFixed(2)}
                          </td>
                        </tr>
                      )
              ...
              <form onSubmit={handlePromoteSupporter} className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full rounded-xl border border-slate-200 dark:border-[#1a2742] bg-slate-50 dark:bg-[#070b14] px-3 py-2 text-sm text-slate-900 dark:text-white focus:outline-none focus:border-blue-500 dark:focus:border-[#ffc72c]"
                  >
                    {fixtures
                ...
                <div className="pt-2 flex justify-end gap-2">
                  ...
                  <button
                    ...
                    className="rounded-xl bg-blue-600 dark:bg-[#ffc72c] px-5 py-2 text-xs font-black text-white dark:text-[#070b14] hover:opacity-90 transition shadow-lg disabled:opacity-50"
                  >
